  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        harmonic: {
          violet: "hsl(var(--harmonic-violet))",
          indigo: "hsl(var(--harmonic-indigo))",
          blue: "hsl(var(--harmonic-blue))",
          cyan: "hsl(var(--harmonic-cyan))",
          green: "hsl(var(--harmonic-green))",
          yellow: "hsl(var(--harmonic-yellow))",
          orange: "hsl(var(--harmonic-orange))",
          red: "hsl(var(--harmonic-red))",
        },
        coherence: {
          high: "hsl(var(--coherence-high))",
          medium: "hsl(var(--coherence-medium))",
          low: "hsl(var(--coherence-low))",
        },
        sphere: {
          geo: "hsl(var(--geosphere))",
          hydro: "hsl(var(--hydrosphere))",
