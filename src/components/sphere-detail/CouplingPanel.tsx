...
const MECHANISMS: Partial<Record<SphereId, Partial<Record<SphereId, string>>>> = {
  ...
  ionosphere: {
    geosphere: "Extraction of minerals, fuels, and aggregates; land sealing and induced seismicity",
    hydrosphere: "Industrial water withdrawal, dams, desalination, runoff, microplastic loading",
    cryosphere: "Greenhouse forcing drives ice loss; black-carbon deposition lowers polar albedo",
    biosphere: "Land-use change, agriculture, supply chains, light and noise pollution",
    atmosphere: "Emissions (CO₂, CH₄, aerosols, ODS) directly forcing atmospheric chemistry and climate",
    magnetosphere: "Geomagnetic storms induce ground currents that damage grids, pipelines, and satellites",
    noosphere: "Compute, networks, and sensing substrate enabling collective cognition",
    crystalsphere: "Anthropogenic EM background overlays natural resonance fields",
  },
  noosphere: {
