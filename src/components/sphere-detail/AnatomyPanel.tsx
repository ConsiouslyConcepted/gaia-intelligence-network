...
const EARTH_IMPACT: Record<SphereId, string> = {
  ...
  heliosphere: "The heliosphere is the Sun-driven plasma bubble that envelopes the entire planetary system and acts as the primary transmission layer through which solar activity reaches Earth. The 11-year solar cycle modulates baseline irradiance, UV/EUV flux, sunspot count, and the frequency of energetic events. Solar wind streams continuously carry magnetized plasma and the interplanetary magnetic field (IMF) outward at 300–800 km/s, compressing the dayside magnetosphere and stretching the nightside magnetotail. Solar flares release intense bursts of X-rays and EUV that ionize the dayside upper atmosphere within minutes, disrupting HF radio and elevating satellite drag. Coronal mass ejections (CMEs) inject billion-ton clouds of magnetized plasma into the heliosphere; when the embedded IMF turns southward at Earth, magnetic reconnection drives geomagnetic storms, auroral expansion, ionospheric scintillation, and induced currents that stress power grids and pipelines. Energetic particles from flares and shock-accelerated CME fronts also pose radiation hazards to satellites, polar aviation, and astronauts. Over longer timescales, solar UV variability influences stratospheric ozone chemistry, total atmospheric column heating, and through cosmic-ray modulation may subtly bias cloud nucleation. The heliosphere is the upstream source of nearly every space-weather signal observed in the magnetosphere, atmosphere, hydrosphere, and biosphere.",
};
