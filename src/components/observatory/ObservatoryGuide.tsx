...
export default function ObservatoryGuide() {
  ...
  // External openers (e.g., top-HUD GuideButton) dispatch this event.
  useEffect(() => {
    const handler = () => setOpen(true);
    window.addEventListener("observatory-guide:open", handler);
    return () => window.removeEventListener("observatory-guide:open", handler);
  }, []);
  ...
  return (
    <>
      {/* Floating launcher removed — opened via GuideButton in each dashboard's top HUD. */}
