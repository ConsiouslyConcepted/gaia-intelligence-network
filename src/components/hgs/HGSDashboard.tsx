...
export const HGSDashboard = ({ onSwitchView }: { onSwitchView?: () => void }) => {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden">
      ...
      {/* ─── LEFT SIDEBAR ─── */}
      {mode === "transits" ? (
        <div className="absolute left-4 top-1/2 -translate-y-[41%] z-10 pointer-events-none w-[250px] h-[620px]">
      ...
      {/* ─── RIGHT SIDEBAR ─── */}
      <div className="absolute right-4 top-1/2 -translate-y-[41%] z-10 pointer-events-none w-[250px] h-[620px]">
